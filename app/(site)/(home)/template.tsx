...
const Template = ({ children }: { children: React.ReactNode }) => {
	...
	// Context
	const { setImagesLoaded, setComponentsLoaded, setRequiresUnicornScene, setUnicornSceneLoaded } = use(GlobalContext);
	...
	}, [imagesReady, componentsReady, setImagesLoaded, setComponentsLoaded]);
