...
description: Configure with styled components helper operations. Auto-activating skill for Frontend Development. Triggers on styled components helper, styled components helper
  Part of the Frontend Development skill category. Use when working with styled components helper functionality. Trigger with phrases like "styled components helper", "styled helper", "styled", "css".
---
...
Tags: react, css, accessibility, web