...
const ICON_MAP: Record<string, { viewBox: string; path: React.ReactNode }> = {
	...
	reset: {
		...
		path: (
			<path
				d='M1.5 10.5007C1.5 10.5007 1.59075 11.1382 4.227 13.7737C5.08007 14.627 6.14628 15.236 7.31463 15.5374C8.48298 15.8388 9.71076 15.8215 10.8701 15.4873C12.0295 15.1531 13.0782 14.5143 13.9068 13.6372C14.7355 12.7602 15.314 11.6771 15.582 10.5007M1.5 10.5007V15.0007M1.5 10.5007H6M16.5 7.50068C16.5 7.50068 16.4093 6.86318 13.773 4.22768C12.9199 3.37437 11.8537 2.76533 10.6854 2.46395C9.51702 2.16257 8.28924 2.17988 7.12985 2.51406C5.97046 2.84825 4.92184 3.4871 4.09315 4.36411C3.26447 5.24112 2.68601 6.32423 2.418 7.50068M16.5 7.50068V3.00068M16.5 7.50068H12'
				strokeLinecap='round'
