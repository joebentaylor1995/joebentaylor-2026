...
// ------------
const createSemanticComponent = (tag: string) => styled(
	tag as keyof JSX.IntrinsicElements | any
)<SemanticProps>`
...
export const getGlobal =
	(color: keyof Theme['colors']['global'], opacity?: number) =>
	(props: { theme: Theme }) => {
...
export const getBrand =
	(color: keyof Theme['colors']['brand'], opacity?: number) =>
	(props: { theme: Theme }) => {
...
export const getFeedback =
	(color: 'positive' | 'negative' | 'warning', opacity?: number) =>
	(props: { theme: Theme }) => {
...
export const getGap =
	(gapSize: keyof Theme['gap']) => (props: { theme: Theme }) => {
		return props.theme.gap[gapSize];
	};

export const getSpace =
	(spaceSize: keyof Theme['space']) => (props: { theme: Theme }) => {
...
export const getFontWeight =
	(fontWeight: keyof Theme['font']['weight']) =>
	(props: { theme: Theme }) => {
		return props.theme.font.weight[fontWeight];
	};

export const getRadius =
	(radiusSize: keyof Theme['br']) => (props: { theme: Theme }) => {
		return props.theme.br[radiusSize];
	};

export const getEase =
	(easeSize: keyof Theme['easing']) => (props: { theme: Theme }) => {
		return props.theme.easing[easeSize];
	};

export const getUtil =
	(util: keyof Theme['utils']) => (props: { theme: Theme }) => {
